...
var findUserById = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, User_1.default.findById(id).exec()];
            case 1: return [2 /*return*/, _a.sent()];
        }
    });
}); };
 ...
 */
var updateUserById = function (id, updateData) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, User_1.default.findByIdAndUpdate(id, updateData, { new: true }).exec()];
            case 1: return [2 /*return*/, _a.sent()];
        }
    });
}); };
...
var deleteUserById = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, User_1.default.findByIdAndDelete(id).exec()];
            case 1: return [2 /*return*/, _a.sent()];
        }
    });
}); };
